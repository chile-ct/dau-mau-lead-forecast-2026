...
- **Direct**: baseline không còn flat-hold TB 3 tháng nữa — dùng **seasonal ratio YoY 2025** (Sep-Dec/TB Jun-Aug cùng kỳ năm ngoái, query thật từ BQ) áp lên mức TB Jun-Aug 2026. Lý do đổi baseline: fit linear trend trực tiếp trên 8 tháng actual 2026 chỉ ra R²≈0.08 (thuần nhiễu, không dùng được) — nhưng so với cùng kỳ 2025 thì có pattern giảm thật ~8-9% từ hè xuống Oct-Dec. Cộng thêm uplift seeding Q4 — đã đọc trực tiếp file "FC2.5 Budget" PDF (không còn nhớ lại số từ trước): dòng "Creative outreach (media boost, booking, seeding, ...)" của **PTY (30tr Sep, 20tr/tháng Oct-Dec) + JOB (82.45tr/tháng Sep-Dec)** — 2 vertical có case study đo hiệu suất thật (2,606đ/lead, T8 seeding 220tr → 84,424 lead). File FC2.5 còn có dòng seeding riêng cho GDS/VEH + 1 dòng "mascot/merchandise" chung PARENT — **không tính vào uplift** vì hiệu suất case study chỉ đo từ PTY, áp cho vertical chưa test là rủi ro overstate (đã note rõ trong deck).
...
**Kết luận quan trọng nhất: PTY đang hụt so với demand vertical cần — cộng dồn -25.3% (Sep -21.8%, Oct -19.9%, Nov -25.6%, Dec -33.6%, Dec là điểm nóng nhất).** Con số này xấu hơn bản trước (-21.9%) vì Direct/Others giờ phản ánh seasonal thật + uplift dùng đúng ngân sách seeding thật thay vì giả định flat/ước lượng — **dùng số này khi trao đổi với vertical/Growth/leadership**, không dùng các số gap từng tính trước đó trong quá trình làm việc (mỗi lần đều có lỗi/thiếu sót đã được sửa dần, lịch sử đầy đủ nằm trong callout "Gap PTY lớn hơn mọi lần tính trước đó" ở tab Problem Reframe).
